...
public class SortableSeleccionarArticulosTable extends SortableTableView<InventarioModel> {
    public SortableSeleccionarArticulosTable(final Context context) {
        this(context, null);
    }

    public SortableSeleccionarArticulosTable(final Context context, final AttributeSet attributes) {
