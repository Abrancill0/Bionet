...
public class ArticuloApartadoModel {
    ...
    List<ImpuestoDeArticuloApartadoModel> Impuestos;
    ...
    public ArticuloApartadoModel(String cantidad, String articulo_id, String articulo_id_variante,
                                 ...
                                 String importe_descuento, String importe_total, List<ImpuestoDeArticuloApartadoModel>  impuestos, String porcentaje_descuento,
                                 String precio_articulo) {
    ...
    public List<ImpuestoDeArticuloApartadoModel>  getImpuestos() {
        return Impuestos;
    }

    public void setImpuestos(List<ImpuestoDeArticuloApartadoModel>  impuestos) {
        Impuestos = impuestos;
    }
