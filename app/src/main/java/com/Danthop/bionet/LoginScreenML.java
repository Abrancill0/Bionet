...
public class LoginScreenML extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.login_screenml);
    ...
    private void processLoginProcessWithError() {
        Toast.makeText(LoginScreenML.this, "Oooops, something went wrong with the login process", Toast.LENGTH_SHORT).show();
    }
}
